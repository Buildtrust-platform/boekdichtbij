...
function toAmsterdamISO(dateStr: string, time: string): string {
  // Create date in Amsterdam timezone and convert to ISO
  const dateTime = new Date(`${dateStr}T${time}:00`);
  // Format for Europe/Amsterdam
...
interface HerenkapperBookingProps {
  citySlug: string;
  areaSlug: string;
  areaLabel: string;
  serviceSlug: string;
...
export default function HerenkapperBooking({
  areaSlug,
  areaLabel,
  ...
  const timeWindows: TimeWindow[] = useMemo(() => {
    ...
    return [
      { key: "today-1500", label: COPY.booking.timeWindowToday1500, dateStr: today, startTime: "15:00", endTime: "16:00" },
      { key: "today-1600", label: COPY.booking.timeWindowToday1600, dateStr: today, startTime: "16:00", endTime: "17:00" },
      { key: "tomorrow-1000", label: COPY.booking.timeWindowTomorrow1000, dateStr: tomorrow, startTime: "10:00", endTime: "11:00" },
      { key: "tomorrow-1100", label: COPY.booking.timeWindowTomorrow1100, dateStr: tomorrow, startTime: "11:00", endTime: "12:00" },
    ];
  }, []);
