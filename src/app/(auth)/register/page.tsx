      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-300 py-2.5 rounded hover:bg-gray-50 disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={socialLoading !== null}
            className="w-full flex items-center justify-center gap-3 bg-black text-white py-2.5 rounded hover:bg-gray-800 disabled:opacity-50"
          >
