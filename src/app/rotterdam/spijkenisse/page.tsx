...
export const metadata: Metadata = {
  title: "Diensten in Spijkenisse | BoekDichtbij",
  description: "Boek eenvoudig een kapper of schoonmaakdienst in Spijkenisse. Transparante prijzen, veilig betalen en wij regelen de rest.",
  keywords: "kapper Spijkenisse, schoonmaak Spijkenisse, diensten Spijkenisse, lokale diensten",
};

export default function SpijkenisseAreaPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-primary-50 via-white to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Diensten in Spijkenisse</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">BoekDichtbij is actief in Spijkenisse. Boek eenvoudig een kapper of schoonmaakdienst, op een moment dat jou uitkomt.</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <Link href="/rotterdam/spijkenisse/herenkapper" className="group bg-white border-2 border-gray-200 rounded-2xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
          ...
          <Link href="/rotterdam/spijkenisse/dameskapper" className="group bg-white border-2 border-gray-200 rounded-2xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-primary-500 transition-colors"><ScissorsIcon className="w-6 h-6 text-primary-600 group-hover:text-white transition-colors" /></div>
          ...
          <Link href="/rotterdam/spijkenisse/schoonmaak" className="group bg-white border-2 border-gray-200 rounded-2xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
      ...
      <footer className="px-4 py-6 border-t border-gray-100 mt-auto">
        <div className="max-w-4xl mx-auto text-center text-sm text-gray-500">
          <Link href="/" className="hover:text-gray-700">BoekDichtbij</Link>{" · "}<Link href="/rotterdam/spijkenisse" className="hover:text-gray-700">Spijkenisse</Link>
        </div>
      </footer>
    </main>
  );
